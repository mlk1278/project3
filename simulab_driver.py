...
# master_sample_means now has 7 rows, each representing an array holding sample means for an n_value.
# For example, accessing master_sample_means[2][249] is accessing the 250th mean (index 249)
